...
export interface DonutChartSegment {
  value: number;
  color: string; // Valid CSS color (hex, rgb, hsl)
  label: string;
  [key: string]: any;
}
...
const DonutChart = React.forwardRef<HTMLDivElement, DonutChartProps>(
  (
    ...
    // Call onSegmentHover prop when internal state changes
    React.useEffect(() => {
    ...
    return (
      ...
      >
        <svg
          ...
          className="overflow-visible -rotate-90" // Start at 12 o'clock
        >
            ...
            {data.map((segment, index) => {
              ...
              return (
                <motion.circle
                  ...
                  style={{
                    filter: isActive
                      ? `drop-shadow(0px 0px 8px ${segment.color}80) brightness(1.1)`
                      : "none",
