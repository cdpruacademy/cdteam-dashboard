  ...
  (
    ...
    const startRecording = useCallback(async () => {
      ...
      function simulateText() {
        const fakeText = "หลักสูตร e-learning ของผลิตภัณฑ์ PRUInfinity เริ่มเมื่อไหร่?";
      ...
      <>
        ...
        >
          ...
          >
            <div
              style={{
                ...
                height: 68,
                transform:
                  hasAttachments && expanded ? "translateY(0)" : "translateY(100%)",
          ...
          <div
            ...
            className={cn(
              "relative w-full border border-gray-300 bg-white shadow-sm focus-within:border-[#ED1C24] focus-within:ring-2 focus-within:ring-[#ED1C24]/20 hover:border-gray-400 z-10",
          ...
          >
            <style
              ...
              .prompt-scrollbar:hover::-webkit-scrollbar-thumb { background: rgba(0,0,0,0.2); }
            `,
              }}
            />
            ...
            <textarea
              ...
              className={cn(
                "prompt-scrollbar absolute top-0 inset-x-0 z-[1] w-full resize-none bg-transparent pl-4 pr-12 py-3 text-sm leading-[22px] text-gray-800 outline-none placeholder:font-medium placeholder:text-gray-400 cursor-text",
                expanded
            ...
            <div
              ref={topFadeRef}
              className="absolute left-4 right-12 top-0 z-[2] h-6 bg-gradient-to-b from-white via-white/90 to-transparent pointer-events-none"
            />
            <div
              ref={bottomFadeRef}
              className="absolute left-4 right-12 z-[2] h-6 bg-gradient-to-t from-white via-white/90 to-transparent pointer-events-none"
              style={{
                opacity: 0,
            ...
            <button
              ...
              className={cn(
                "absolute inset-x-0 top-0 z-[1] cursor-text pl-4 pr-12 py-[14px] text-left text-sm font-medium leading-[17px] text-gray-500 outline-none",
                !expanded
                  ? "opacity-100 scale-100 translate-y-0"
            ...
            >
              <div className="relative">
                <button
                  ...
                  className={cn(
                    "group flex items-center gap-1 rounded-full px-2 py-1 text-gray-600 transition-all duration-200 outline-none hover:bg-gray-100 hover:text-gray-900 cursor-default",
                    isModelSelectOpen ? "bg-gray-100 text-gray-900" : ""
                  )}
                ...
                <div
                  ...
                  className={cn(
                    "absolute bottom-full left-0 mb-2.5 z-50 w-44 rounded-2xl border border-gray-200 bg-white p-1 shadow-xl backdrop-blur-md flex flex-col gap-0.5 transition-all duration-400 cursor-default",
                    isModelSelectOpen
                ...
                >
                  <div className="relative flex flex-col gap-0.5">
                    <div
                      style={hoverStyle}
                      className="absolute left-0 right-0 top-0 h-8 -z-10 rounded-xl bg-gray-100 pointer-events-none"
                    />
                    {models.map((model, idx) => (
                      <button
                        ...
                        className="group relative flex h-8 w-full items-center justify-between rounded-xl px-2.5 py-1.5 text-left text-xs font-medium text-gray-700 outline-none active:scale-[0.98] cursor-default"
                      >
              ...
              <button
                ...
                onMouseDown={(e) => e.preventDefault()}
                onClick={cycleEffort}
                className="group flex items-center gap-1 rounded-full px-2 py-1 text-gray-600 transition-all duration-200 hover:bg-gray-100 hover:text-gray-900 outline-none cursor-default"
              >
              ...
              <button
                ...
                className="ml-auto flex size-7 items-center justify-center rounded-full text-gray-500 transition-all duration-200 hover:bg-gray-100 hover:text-gray-900 outline-none cursor-default disabled:opacity-40 disabled:pointer-events-none"
                title="แนบรูปภาพ"
              >
                <PlusIcon />
              </button>
            ...
            >
              {audioData.map((val, i) => (
                <div
                  key={i}
                  className="w-1 rounded-full bg-[#ED1C24] transition-[height] duration-75 ease-out"
                  style={{ height: `${Math.max(4, val * 24)}px` }}
                />
              ))}
            </div>

            {/* Red Prudential Primary Button for Send/Mic */}
            <button
              type="button"
              onMouseDown={(e) => {
                e.preventDefault();
              ...
              className="absolute right-2 bottom-2 z-[10] flex h-8 w-8 items-center justify-center bg-[#ED1C24] hover:bg-[#D4181F] text-white transition-all duration-300 outline-none focus-visible:ring-2 focus-visible:ring-[#ED1C24] cursor-default shadow-xs"
            >
